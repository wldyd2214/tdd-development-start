...
import sample.tdd.unit.chap07.user.fucntion.SpyEmailNotifier;
import sample.tdd.unit.chap07.user.fucntion.StubWeakPasswordChecker;
...
public class UserRegisterTest {
    ...
    @Test
    void dupIdExists() {
        fakeRepository.save(new User("id", "pw1", "eamil@email.com"));
